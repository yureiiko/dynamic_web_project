...
<html>
	...
	<body>
		...
		<div class="der">
			<span id="p" onclick="revFrame(0)"><h4>Your Products</h4></span>
			<span id="b" onclick="revFrame(1)"><h4>Add a Product</h4></span>
			<span id="s" onclick="revFrame(2)"><h4>Your Sales</h4></span>
		</div>
