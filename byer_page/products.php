...
<div class="Castle-containers">
  ...
  while ($row = mysqli_fetch_array($res)) {
    ...
    <div class='conteneur'>
      <div class='card'>
        <img src='../style/img/".$row["img_src"]."' alt=''><br>
          <center>
            <div class='description'>
              <b>".$row["descrip"]."</b><br>
              <p id='total-amount'> Price: £".$row["price"]."</p>
...
>>>>>>> c8b38e2557069445d41c5a38b638c766b307c3b6:products.php
>>>>>>> Stashed changes:byer_page/products.php
</html>