...
<html>
	...
	<body>
        ...
        $query = "select p.id_prod, p.img_src, p.descrip, a.max_price, s.username from product p, auction a, seller s where p.id_prod=a.id_prod and p.id_seller=s.id_seller";
