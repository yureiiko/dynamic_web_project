					...
					if ($res->num_rows==1) {
						...
						switch ($_POST['usrtype']) {
							case 'admin':
								...
								header("Location: ../admin_page/admin_main.php");
								break;
							case 'seller':
								setcookie("seller", $row['id_seller']);
								header("Location: ../seller_page/index_admin.php");
								break;
							case 'buyer':
								setcookie("buyer", $row['id_buyer']);
								header("Location: ../byer_page/index_buyer.php");
								break;
							default:
								break;
						}
				...
				<div class="banner">
					<div class="content">
						...
						<form action="" method="POST">
							...
							<input type="text" placeholder="" style="margin-left: 90px;" name="usrname"><br>
							<label>Password</label>
							<input type="password" placeholder="" style="margin-left: 60px;" name="passwd"><br>
							<button type="submit" value="Log In"><span></span>Log In</button><br>
						</form>
						<div>
							<p>Don't have an account? <a href="../create/su.html">Sign Up here</a>
							<!--<p>Don't have an account? <a href="https://form.jotform.com/231973997882378">Sign Up here</a></p>-->
						</div>
					</div>
				</div>
			</div>
